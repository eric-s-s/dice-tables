...
class TestDiceStats(unittest.TestCase):
    ...
    def test_DiceRecord_init_empty_items(self):
    ...
    def test_DiceRecord_get_items(self):
    ...
    def test_DetailedDiceTable_init_does_has_correct_calc(self):
        table = DetailedDiceTable({1: 1}, [])
    ...
    def test_DetailedDiceTable_update_resets_calc(self):
        table = DetailedDiceTable({1: 1}, [])
        table.add_die(1, Die(2))
        self.assertEqual(table.calc.percentage_points(), [(2, 50.0), (3, 50.0)])

    def test_DetailedDiceTable_update_keeps_include_zeroes_info_true(self):
        table = DetailedDiceTable({1: 1}, [], calc_includes_zeroes=True)
        table.add_die(1, Die(2))
        self.assertTrue(table.calc.include_zeroes)

    def test_DetailedDiceTable_update_keeps_include_zeroes_info_false(self):
        table = DetailedDiceTable({1: 1}, [], calc_includes_zeroes=False)
        table.add_die(1, Die(2))
        self.assertFalse(table.calc.include_zeroes)

    def test_DetailedDiceTable_set_calc_includes_zeroes_setter_switches_calc_status(self):
        table = DetailedDiceTable({1: 1}, [], calc_includes_zeroes=False)
    ...
    def test_DetailedDiceTable_info_property_updates(self):
        table = DetailedDiceTable({1: 1}, [], calc_includes_zeroes=False)
        self.assertEqual(table.info.all_events(), [(1, 1)])
        table.add_die(1, Die(2))
    ...
    def test_DetailedDiceTable_add_die_updates_calc_and_info(self):
        table = DetailedDiceTable.new()
        table.add_die(1, Die(2))
    ...
    def test_DetailedDiceTable_combine_by_dictionary_updates_calc_and_info(self):
        table = DetailedDiceTable.new()
        table.combine_by_dictionary(1, Die(2))
        self.assertEqual(table.info.all_events(), [(1, 1), (2, 1)])
        self.assertEqual(table.calc.percentage_points(), [(1, 50.0), (2, 50.0)])

    def test_DetailedDiceTable_combine_by_flattened_list_updates_calc_and_info(self):
        table = DetailedDiceTable.new()
        table.combine_by_flattened_list(1, Die(2))
        self.assertEqual(table.info.all_events(), [(1, 1), (2, 1)])
        self.assertEqual(table.calc.percentage_points(), [(1, 50.0), (2, 50.0)])

    def test_DetailedDiceTable_combine_by_indexed_values_updates_calc_and_info(self):
        table = DetailedDiceTable.new()
    ...
    def test_DetailedDiceTable_remove_die_updates_calc_and_info(self):
        table = DetailedDiceTable({1: 1, 2: 1}, [(Die(2), 1)])
        table.remove_die(1, Die(2))
        self.assertEqual(table.info.all_events(), [(0, 1)])
        self.assertEqual(table.calc.percentage_points(), [(0, 100.0)])

    def test_DetailedDiceTable_remove_updates_calc_and_info(self):
        table = DetailedDiceTable({1: 1, 2: 1}, [])
