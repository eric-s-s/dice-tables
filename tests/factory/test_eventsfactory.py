...
class TestEventsFactory(unittest.TestCase):
    ...
    def test_Loader_bad_factory_keys_raises_EventsFactoryError(self):
        ...
        self.assert_EventsFactoryError_code(
            "CLASS OVERWRITE", Loader(EventsFactory).load, BadByClassPresentButDifferent
        )
        self.assert_EventsFactoryError_code(
            "MISSING GETTER", Loader(EventsFactory).load, BadByBadKeyName
        )
    ...
    def test_Loader_new_keys(self):
        ...
        self.assertEqual(
            EventsFactory.get_getter_string("my_method"), 'method: "my_method", default: 5'
        )
        self.assertEqual(
            EventsFactory.get_getter_string("my_property"),
            "property: \"my_property\", default: 'a'",
        )
    ...
    def test_EventsFactory_add_class_already_has_class_raises_EventsFactoryError(self):
        self.assert_EventsFactoryError_code(
            "CLASS OVERWRITE", EventsFactory.add_class, AdditiveEvents, ("dice_data",)
        )
    ...
    def test_EventsFactory_add_class_factory_missing_getter_raises_EventsFactoryError(self):
        ...
        self.assert_EventsFactoryError_code(
            "MISSING GETTER", EventsFactory.add_class, Bob, ("not_there",)
        )

    def test_EventsFactory_add_getter_new_method(self):
        EventsFactory.add_getter("get_num", 0)
        self.assertEqual(
            EventsFactory.get_getter_string("get_num"), 'method: "get_num", default: 0'
        )

    def test_EventsFactory_add_getter_new_property(self):
        EventsFactory.add_getter("get_num", 0, type_str="property")
        self.assertEqual(
            EventsFactory.get_getter_string("get_num"), 'property: "get_num", default: 0'
        )

    def test_EventsFactory_add_getter_already_there_does_nothing(self):
        EventsFactory.add_getter("get_dict", {0: 1})
        self.assertEqual(
            EventsFactory.get_getter_string("get_dict"), 'method: "get_dict", default: {0: 1}'
        )

    def test_EventsFactory_add_getter_already_not_equal_raises_error(self):
        self.assert_EventsFactoryError_code(
            "GETTER OVERWRITE", EventsFactory.add_getter, "get_dict", {1: 1}
        )
        self.assert_EventsFactoryError_code(
            "GETTER OVERWRITE", EventsFactory.add_getter, "get_dict", {0: 1}, "property"
        )
    ...
    def test_EventsFactory_check_raises_warning(self):
        self.assert_EventsFactoryWarning_code(
            ["CHECK"], EventsFactory.check, NewDiceTableNewInitNoUpdate
        )
    ...
    def test_EventsFactory_construction__new_class_has_no_update_info_init_did_not_change(self):
        self.assert_EventsFactoryWarning_code(
            ["CHECK", "CONSTRUCT"], EventsFactory.new, NewDiceTableSameInitNoUpdate
        )
    ...
    def test_EventsFactory_construction__new_class_has_no_update_info_init_did_change(self):
        self.assert_EventsFactoryWarning_code(
            ["CONSTRUCT"], EventsFactory.new, NewDiceTableNewInitNoUpdate
        )
    ...
    def test_EventsFactory_construction__totally_unrelated_object_with_no_loader_raises_EventsFactoryError(
        self,
    ):
        class Bob(object):
            pass
    ...
    def test_EventsFactory_construction__class_present_wrong_signature_wrong_param_EventsFactoryError(
        self,
    ):
        class Bob(AdditiveEvents):
            pass
    ...
    def test_EventsFactory_construction__class_present_different_signature_too_many_params_EventsFactoryError(
        self,
    ):
        class Bob(AdditiveEvents):
            pass
    ...
    def test_EventsFactory_construction__class_present_different_signature_too_few_params_EventsFactoryError(
        self,
    ):
        class Bob(DiceTable):
            pass
    ...
    def test_EventsFactory_construction__class_present_wrong_signature_wrong_order_EventsFactoryError(
        self,
    ):
        class Bob(DiceTable):
            pass
    ...
    def test_Events_Factory_warning_correct_message_raised_CHECK(self):
        will_warn_insert = (
            "TestEventsFactory.test_Events_Factory_warning_correct_message_raised_CHECK.<locals>."
        )
        if version_info[0] < 3:
            will_warn_insert = ""
        ...
        self.assert_EventsFactoryWarning_code(
            [expected.format(will_warn)], EventsFactory.check, WillWarn
        )

    def test_Events_Factory_warning_correct_message_CONSTRUCT(self):
        will_warn_insert = (
            "TestEventsFactory.test_Events_Factory_warning_correct_message_CONSTRUCT.<locals>."
        )
        if version_info[0] < 3:
            will_warn_insert = ""
        will_warn = "tests.factory.test_eventsfactory.{}WillWarn".format(will_warn_insert)
        ...
        self.assert_EventsFactoryWarning_code(
            [expected.format(will_warn), "CHECK"], EventsFactory.new, WillWarn
        )
    ...
    def test_Events_Factory_error_correct_message_CLASS_OVERWRITE(self):
        ...
        self.assert_EventsFactoryError_contains(
            expected, EventsFactory.add_class, DiceTable, ("dice_data",)
        )
    ...
    def test_Events_Factory_error_correct_message_MISSING_GETTER(self):
        bob_insert = (
            "TestEventsFactory.test_Events_Factory_error_correct_message_MISSING_GETTER.<locals>."
        )
        if version_info[0] < 3:
            bob_insert = ""
    ...
    def test_BUG_inheritance_issue_RESOLVED_as_best_as_can_be_without_metaclass(self):
        ...
        self.assertEqual(
            EventsFactory.get_keys()[0], ["AdditiveEvents", "DetailedDiceTable", "DiceTable"]
        )
        self.assertEqual(
            C.get_keys()[0], ["AdditiveEvents", "DetailedDiceTable", "DiceTable", "int"]
        )
        EventsFactory.reset()
        ...
        self.assertEqual(
            B.get_keys()[0], ["AdditiveEvents", "DetailedDiceTable", "DiceTable", "int"]
        )
        C.reset()
    ...
    def test_object_of_astonishing_idiocy(self):
        class DoubleTable(DiceTable):
            ...
            def combine(self, events, times=1):
                new_alt_dict = DictCombiner(self._additive.get_dict()).combine_by_fastest(
                    events.get_dict(), times
                )
                return EventsFactory.from_params(self, {"get_dict_alt": new_alt_dict})

            def remove(self, events, times=1):
                new_alt_dict = DictCombiner(self._additive.get_dict()).remove_by_tuple_list(
                    events.get_dict(), times
                )
                return EventsFactory.from_params(self, {"get_dict_alt": new_alt_dict})
    ...
    def test_deep_depths_of_dumbness(self):
        ...
        self.assertEqual(
            msg, "I woke up this morning with a bad hangover and my D5 was missing again."
        )
    ...
    def test_a_silly_example_to_show_EventsDictCreator_and_EventsFactory_from_params(self):
        ...
        class ModifierTable(DiceTable):
            ...
            def change_mod(self, new_modifier):
                ...
                new_dict = DictCombiner(self.get_dict()).combine_by_dictionary(
                    change_events.get_dict(), 1
                )
                return EventsFactory.from_params(
                    self, {"get_dict": new_dict, "modifier": new_modifier}
                )
