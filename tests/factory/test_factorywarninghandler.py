...
class TestEventsFactoryWarningHandler(unittest.TestCase):
    ...
    def test_create_message_header(self):
        ...
        self.assertEqual(
            create_message_header("CHECK", EventsFactory, EventsFactoryWarningHandler), expected
        )
    ...
    def test_create_error_code_body_CONSTRUCT(self):
        ...
        self.assertEqual(
            create_error_code_body((EventsFactoryWarningHandler, AdditiveEvents), "CONSTRUCT"),
            expected,
        )
    ...
    def test_create_error_code_body_CHECK(self):
        ...
        self.assertEqual(
            create_error_code_body((EventsFactoryWarningHandler, AdditiveEvents), "CHECK"), expected
        )
    ...
    def test_create_warning_message(self):
        ...
        self.assertEqual(
            create_warning_message(factory, code, failed_class, found_class), start + middle + end
        )
    ...
    def test_FactoryWarningHandler_warning_by_CHECK(self):
        ...
        self.assert_warning(
            EventsFactoryWarning,
            msg,
            EventsFactoryWarningHandler(EventsFactory).raise_warning,
            "CHECK",
            DiceTable,
            AdditiveEvents,
        )
