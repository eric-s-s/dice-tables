...
from dicetables.tools.numberforamtter import (
    NumberFormatter,
    remove_extra_zero_from_single_digit_exponent,
)
...
class TestNumberFormatter(unittest.TestCase):
    ...
    def test_NumberFormatter_get_exponent_between_pos_one_and_neg_one__big_small_pos_neg_no_rounding(
        self,
    ):
    ...
    def test_NumberFormatter_get_exponent_gt_one__float_pos_neg_no_rounding(self):
        formatter = NumberFormatter()
        self.assertEqual(formatter.get_exponent(1e5), 5)
        self.assertEqual(formatter.get_exponent(-1e5), 5)
        self.assertEqual(formatter.get_exponent(Decimal("1e+1000")), 1000)
        self.assertEqual(formatter.get_exponent(Decimal("-1e+1000")), 1000)
    ...
    def test_NumberFormatter_format_edge_of_one_switches_algorithm(self):
        ...
        self.assertEqual(exponent_formatter.format(0.999949), "9.999e-1")
        self.assertEqual(exponent_formatter.format(0.999951), "1.000")
        self.assertEqual(fixed_point_formatter.format(0.999949), "0.9999")
        self.assertEqual(fixed_point_formatter.format(0.999951), "1.000")
