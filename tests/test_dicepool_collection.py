...
class TestBestWorstMid(unittest.TestCase):
    ...
    def test_DicePool_weight_info(self):
        test = MockOfDicePoolCollection(DicePool(Die(6), 3), 2)
        self.assertEqual(test.weight_info(), 'MockCollection 2 of 3D6\ninput_die info:\n    No weights')
    ...
    def test_WorstOfDicePool_multiply_str(self):
        self.assertEqual(WorstOfDicePool(DicePool(Die(2), 2), 1).multiply_str(3), '3(Worst 1 of 2D2)')
    ...
    def test_UpperMidOfDicePool_multiply_str(self):
        self.assertEqual(UpperMidOfDicePool(DicePool(Die(2), 2), 1).multiply_str(3), '3(UpperMid 1 of 2D2)')

    def test_UpperMidOfDicePool_weight_info(self):
        self.assertEqual(UpperMidOfDicePool(DicePool(Die(2), 2), 1).weight_info(),
                         'UpperMid 1 of 2D2\ninput_die info:\n    No weights')
    ...
    def test_LowerMidOfDicePool_multiply_str(self):
        self.assertEqual(LowerMidOfDicePool(DicePool(Die(2), 2), 1).multiply_str(3), '3(LowerMid 1 of 2D2)')

    def test_LowerMidOfDicePool_weight_info(self):
        self.assertEqual(LowerMidOfDicePool(DicePool(Die(2), 2), 1).weight_info(),
                         'LowerMid 1 of 2D2\ninput_die info:\n    No weights')
