...
That's all of the basic implementation. The rest of this is details
...
* A die with a modifier.  The modifier is added to each die roll. dt.ModDie(4, -2) rolls -1, 0, 1, 2 
with equal weight.
* added methods:
...
interesting inheritance effects. see [inheritance](#inheritance).
